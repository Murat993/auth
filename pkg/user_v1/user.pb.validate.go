...
func (m *UserUpdate) validate(all bool) error {
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, UserUpdateValidationError{
					field:  "Name",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return UserUpdateValidationError{
				field:  "Name",
				reason: "embedded message failed validation",
				cause:  err,
			}
...
func (m *CreateRequest) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetUseCreate()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
	...
	} else if v, ok := interface{}(m.GetUseCreate()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
