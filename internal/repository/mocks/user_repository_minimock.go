...
//go:generate minimock -i github.com/Murat993/auth/internal/repository.UserRepository -o ./mocks/user_repository_minimock.go -n UserRepositoryMock
...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, userCreate *dto.UserCreate) (s1 string, err error)
	inspectFuncCreate   func(ctx context.Context, userCreate *dto.UserCreate)
	...
	funcGet          func(ctx context.Context, id string) (up1 *dto.User, err error)
	inspectFuncGet   func(ctx context.Context, id string)
	afterGetCounter  uint64
	beforeGetCounter uint64
	GetMock          mUserRepositoryMockGet

	funcUpdate          func(ctx context.Context, userUpdate *dto.UserUpdate) (s1 string, err error)
	inspectFuncUpdate   func(ctx context.Context, userUpdate *dto.UserUpdate)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, userCreate *dto.UserCreate) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, userCreate *dto.UserCreate)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, userCreate *dto.UserCreate) (s1 string, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, userCreate *dto.UserCreate) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, userCreate *dto.UserCreate) (s1 string, err error) {
...
func (mmGet *mUserRepositoryMockGet) Return(up1 *dto.User, err error) *UserRepositoryMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserRepositoryMockGet) Set(f func(ctx context.Context, id string) (up1 *dto.User, err error)) *UserRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserRepositoryMockGetExpectation) Then(up1 *dto.User, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetResults{up1, err}
	return e.mock
}

// Get implements repository.UserRepository
func (mmGet *UserRepositoryMock) Get(ctx context.Context, id string) (up1 *dto.User, err error) {
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, userUpdate *dto.UserUpdate) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserRepositoryMockUpdateParams{ctx, userUpdate}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, userUpdate *dto.UserUpdate)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Return(s1 string, err error) *UserRepositoryMock {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	mmUpdate.defaultExpectation.results = &UserRepositoryMockUpdateResults{s1, err}
	return mmUpdate.mock
}

// Set uses given function f to mock the UserRepository.Update method
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, userUpdate *dto.UserUpdate) (s1 string, err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, userUpdate *dto.UserUpdate) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateExpectation{
		mock:   mmUpdate.mock,
		params: &UserRepositoryMockUpdateParams{ctx, userUpdate},
	}
...
func (e *UserRepositoryMockUpdateExpectation) Then(s1 string, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockUpdateResults{s1, err}
	return e.mock
}

// Update implements repository.UserRepository
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, userUpdate *dto.UserUpdate) (s1 string, err error) {
	mm_atomic.AddUint64(&mmUpdate.beforeUpdateCounter, 1)
	defer mm_atomic.AddUint64(&mmUpdate.afterUpdateCounter, 1)

	if mmUpdate.inspectFuncUpdate != nil {
		mmUpdate.inspectFuncUpdate(ctx, userUpdate)
	}

	mm_params := &UserRepositoryMockUpdateParams{ctx, userUpdate}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateParams{ctx, userUpdate}
		if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
	...
	if mmUpdate.funcUpdate != nil {
		return mmUpdate.funcUpdate(ctx, userUpdate)
	}
	mmUpdate.t.Fatalf("Unexpected call to UserRepositoryMock.Update. %v %v", ctx, userUpdate)
	return
}
