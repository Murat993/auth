...
//go:generate minimock -i github.com/Murat993/auth/internal/service.UserService -o ./mocks/user_service_minimock.go -n UserServiceMock
...
type UserServiceMock struct {
	...
	funcCreate          func(ctx context.Context, user *dto.UserCreate) (s1 string, err error)
	inspectFuncCreate   func(ctx context.Context, user *dto.UserCreate)
	...
	funcUpdate          func(ctx context.Context, user *dto.UserUpdate) (s1 string, err error)
	inspectFuncUpdate   func(ctx context.Context, user *dto.UserUpdate)
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, user *dto.UserCreate) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, user *dto.UserCreate)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, user *dto.UserCreate) (s1 string, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, user *dto.UserCreate) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, user *dto.UserCreate) (s1 string, err error) {
...
func (mmGet *mUserServiceMockGet) Return(up1 *dto.User, err error) *UserServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
...
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, id string) (up1 *dto.User, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserServiceMockGetExpectation) Then(up1 *dto.User, err error) *UserServiceMock {
	e.results = &UserServiceMockGetResults{up1, err}
	return e.mock
}

// Get implements service.UserService
func (mmGet *UserServiceMock) Get(ctx context.Context, id string) (up1 *dto.User, err error) {
...
func (mmUpdate *mUserServiceMockUpdate) Expect(ctx context.Context, user *dto.UserUpdate) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Inspect(f func(ctx context.Context, user *dto.UserUpdate)) *mUserServiceMockUpdate {
...
func (mmUpdate *mUserServiceMockUpdate) Return(s1 string, err error) *UserServiceMock {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	mmUpdate.defaultExpectation.results = &UserServiceMockUpdateResults{s1, err}
	return mmUpdate.mock
}

// Set uses given function f to mock the UserService.Update method
func (mmUpdate *mUserServiceMockUpdate) Set(f func(ctx context.Context, user *dto.UserUpdate) (s1 string, err error)) *UserServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserServiceMockUpdate) When(ctx context.Context, user *dto.UserUpdate) *UserServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
func (e *UserServiceMockUpdateExpectation) Then(s1 string, err error) *UserServiceMock {
	e.results = &UserServiceMockUpdateResults{s1, err}
	return e.mock
}

// Update implements service.UserService
func (mmUpdate *UserServiceMock) Update(ctx context.Context, user *dto.UserUpdate) (s1 string, err error) {
